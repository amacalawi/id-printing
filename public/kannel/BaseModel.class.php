...
class BaseModel
{
  ...
  function enroll($table, $mem_id, $schoolyear_id)
  {
    $query = "INSERT INTO " . $table . " (member_id, schoolyear_id, enrollment_status)VALUES(".$mem_id.",".$schoolyear_id.",'NEW');";
    $this->query($query);
    $id = $this->query("SELECT LAST_INSERT_ID();", true);
    return $id[0][0];
  }
