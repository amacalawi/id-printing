!function($) {
    ...
    wizzardS.prototype.do_uploads = function($id) {
        ...
        $.ajax({
            type: "POST",
            url: base_url + 'applications/uploads?files=utility-models&id=' + $id,
            data: data,
            cache: false,
            processData: false,
            contentType: false,
    ...
    {   
            ...
            if ($('input[name="app_no"]').val() == '') { 
                ...
                */   
                ...
                {   
                    ...
                    */
                    var $url = (appID.val() != '') ? 
                        base_url + 'applications/utility-models/update/' + appID.val() + '?file1=' + inputfile1 + '&file2=' + inputfile2 + '&file3=' + inputfile3 + '&file4=' + inputfile4 + '&file7=' + inputfile7 : 
                        base_url + 'applications/utility-models/store?file1=' + inputfile1 + '&file2=' + inputfile2 + '&file3=' + inputfile3 + '&file4=' + inputfile4 + '&file7=' + inputfile7;
        ...
        */
        ...
        this.$body.on('click', '.download-file', function (e){
            ...
            var $url = base_url + 'applications/downloads?files=utility-models&id=' + $id + '&filename=' + $filename;
