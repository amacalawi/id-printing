    ...
    {   
            ...
            if ($('input[name="app_no"]').val() == '') { 
                ...
                */   
                ...
                {   
                    ...
                    */
                    var $url = (appID.val() != '') ? 
                    base_url + 'applications/trademarks/update/' + appID.val() + '?file1=' + inputfile1 + '&file2=' + inputfile2 + '&file3=' + inputfile3 + '&file4=' + inputfile4 + '&file5=' + inputfile5 : 
                    base_url + 'applications/trademarks/store?file1=' + inputfile1 + '&file2=' + inputfile2 + '&file3=' + inputfile3 + '&file4=' + inputfile4 + '&file5=' + inputfile5;
        ...
        */
        ...
        this.$body.on('click', '#add-more-renewal', function (e){
            ...
            '<td class="hidden"><input name="dau_due_date_' + $dau_iteration + '" class="duedate"></td>' +
            '<td>' +
            '<input id="dau_due_date_clone_' + $dau_iteration + '" class="duedateclone text-center form-control m-input m-input--solid date-picker" placeholder="" name="dau_due_date_clone_' + $dau_iteration + '" type="text" value="">' +
            '</td>' + 
            '<td>' +
        ...
        this.$body.on('click', '#add-more-renewal-dau', function (e){
            ...
            '<td class="hidden"><input name="renewal_dau_due_date_' + $renewal_dau_iteration + '" class="duedate_renewal"></td>' +
            '<td>' +
            '<input id="renewal_dau_due_date_clone_' + $renewal_dau_iteration + '" class="duedateclone_renewal text-center form-control m-input m-input--solid date-picker" placeholder="" name="renewal_dau_due_date_clone_' + $renewal_dau_iteration + '" type="text" value="">' +
            '</td>' + 
            '<td>' +
